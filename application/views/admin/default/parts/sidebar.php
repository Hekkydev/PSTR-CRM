                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo $base_assets_url;?>img/avatar3.png" class="img-responsive" alt="User Image" />
                        </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php echo ($parent_menu == 'post')? 'active' : '' ?>">
                            ...
                            <ul class="treeview-menu" <?php echo ($parent_menu == 'post')? 'style="display:block"' : 'style="display:none"' ?>>
                                <li><a href="<?php echo site_url($admin_url.'/posts/add')?>"><i class="fa fa-angle-double-right"></i> New Post</a></li>
                                <li><a href="<?php echo site_url($admin_url.'/posts/')?>"><i class="fa fa-angle-double-right"></i> All Posts</a></li>
                                <?php if(in_array('admin',$current_groups)):?>
                                    <li><a href="<?php echo site_url($admin_url.'/categories')?>"><i class="fa fa-angle-double-right"></i> Categories</a></li>
                                    <li><a href="<?php echo site_url($admin_url.'/tags')?>"><i class="fa fa-angle-double-right"></i> Tags</a></li>
                                <?php endif;?>
                            </ul>
                        </li>
                        <?php if(in_array('admin',$current_groups)):?>
                            <li class="active">
                                <a href="<?php echo site_url($admin_url.'/pages')?>">
                                    <i class="fa fa-file"></i> <span>Static Page</span>
                                </a>
                            </li>
                            <li class="active">
                                <a href="<?php echo site_url($admin_url.'/menus')?>">
                            ...
                            <li class="treeview <?php echo ($parent_menu == 'user')? 'active' : '' ?>">
							 ...
							 <li class="active">
                                <a href="<?php echo site_url($admin_url.'/assets/filemanager')?>">
                                    <i class="fa fa-upload"></i> <span>Upload</span>
                                </a>
                            </li>
                             <li class="active">
                                <a href="<?php echo site_url($admin_url.'/slider')?>">
                                    <i class="fa fa-picture-o"></i> <span>Slider</span>
                                </a>
                            </li>
                            <li class="active">
                                <a href="<?php echo site_url($admin_url.'/settings')?>">
